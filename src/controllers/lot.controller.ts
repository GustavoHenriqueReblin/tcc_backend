...
import { lotService as service } from "@services/services";
...
export const getAllLots = async (req: Request, res: Response) => {
    ...
    return sendResponse(res, result, "Lots fetched successfully");
};
...
export const getLotById = async (req: Request, res: Response) => {
    ...
    return sendResponse(res, result, "Lot fetched successfully");
};
...
export const createLot = async (req: Request, res: Response) => {
    ...
    return sendResponse(res, result, "Lot created successfully");
};
