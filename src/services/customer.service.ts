...
import { customerAllowedSortFields, customerPersonAllowedSortFields } from "@routes/customer.routes";
    ...
    getAll = async (
        ...
        this.safeQuery(
            async () => {
                ...
                const validSortFields = customerPersonAllowedSortFields.concat(customerAllowedSortFields);
